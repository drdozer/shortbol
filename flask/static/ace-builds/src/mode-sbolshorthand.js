...
//var qnametok = "constant.buildin.qname";
//var urltok = "constant.buildin.url";
...
//                        return [templatetok, "keyword.rightarrowstate"]
//                    },
...
//});
//
//define("ace/mode/sbolshorthand", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/sbol_highlight_rules", "ace/mode/folding/sbolshorthandfold", "ace/range"], function (require, exports, module) {
//    "use strict";
//
//    var oop = require("../lib/oop");
...
//                return indent;
//            }
//            if (tokens.length && tokens[tokens.length -1].type == prefixConstok) {
//                return indent += tab;
//            }
//
//            return indent;
